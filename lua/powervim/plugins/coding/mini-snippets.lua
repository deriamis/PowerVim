if not vim.g.powervim_snippets == "mini" then
  return {}
end
...
local include_in_completion = vim.g.powervim_snippets_in_completion == nil or vim.g.powervim_snippets_in_completion
...
return {
  ...
  desc = "Manage and expand snippets (alternative to Luasnip)",
  {
    ...
    opts = function()
      ...
      PowerVim.cmp.actions.snippet_stop = function() end -- by design, <esc> should not stop the session!
      ---@diagnostic disable-next-line: duplicate-set-field
