...
opt.foldlevel = 99
opt.formatexpr = "v:lua.require'powervim.util'.format.formatexpr()"
...
if vim.fn.has("nvim-0.10") == 1 then
  ...
  opt.foldexpr = "v:lua.require'powervim.util'.ui.foldexpr()"
  opt.foldmethod = "expr"
  opt.foldtext = ""
else
  opt.foldmethod = "indent"
  opt.foldtext = "v:lua.require'powervim.util'.ui.foldtext()"
end
